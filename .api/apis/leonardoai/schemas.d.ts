    ...
    readonly body: {
        readonly properties: {
            ...
            readonly controlNet: {
                readonly title: "Boolean";
                readonly type: readonly ["boolean", "null"];
                readonly description: "Enable to use ControlNet. Requires an init image to be provided. Requires a model based on SD v1.5";
            };
            readonly controlNetType: {
                readonly type: readonly ["string", "null"];
                readonly title: "controlnet_type";
                readonly enum: readonly ["POSE", "CANNY", "DEPTH"];
                readonly description: "The type of ControlNet to use.";
            };
            readonly elements: {
                readonly items: {
                    readonly properties: {
            ...
            readonly weighting: {
                readonly title: "Float";
                readonly type: readonly ["number", "null"];
                readonly description: "How much weighting to use for ControlNet. This parameter works with controlNet and controlNetType.";
            };
            readonly width: {
                readonly title: "Int";
                readonly type: readonly ["integer", "null"];
